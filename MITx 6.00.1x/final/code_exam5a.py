...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        ...
        for z in self.myCourses:
            if course == z.courseName:
                self.myCourses[x].setGrade(grade)
            x +=1
    ...
    def getGrade(self, course="6.02x"):
        ...
        for y in self.myCourses:
            classes.append(y.courseName)
        if course not in classes:
            return -1
        x = 0
        for z in self.myCourses:
            if z.courseName == course:
                return self.myCourses[x].getGrade()
            x +=1
    ...
    def setPset(self, pset, score, course="6.00x"):
        ...
        for z in self.myCourses:
            if z.courseName == course:
                self.myCourses[x].setPset(pset, score)
            x +=1
    ...
    def getPset(self, pset, course="6.00x"):
        ...
        for z in self.myCourses:
            if z.courseName == course:
                return self.myCourses[x].getPset(pset)
            x +=1
